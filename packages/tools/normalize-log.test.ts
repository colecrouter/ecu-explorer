...
describe("normalize-log", () => {
	const sampleCsv = [
		"LogID,LogEntryDate,LogEntryTime,LogEntrySeconds,LogNotes,2ByteRPM,AFR,WGDC_Active,Battery,Baro,Load,Speed",
		"1,2026-03-15,22:34:39.62814,0.22742,,1054.6875,14.7,35.2,14.5,96.5,1.5,42",
		"2,2026-03-15,22:34:39.72191,0.32444,,1200,14.4,40.1,14.4,98.2,1.7,44",
		"",
	].join("\n");
